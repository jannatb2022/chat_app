...
const Contacts = ({contacts, changechat}) => {
    const [cuUsername, setCuUsername] = useState(undefined);
    const [cuImage, setCuImage] = useState(undefined);
    ...
    useEffect(() => {
        ...
        async function user (){
            ...
            setCuUsername( data.username);
            setCuImage(data.avatarImage)
        }
        user()
    }, [])
      ...
      {cuUsername && (
        <Container>
          ...
          <div className="current-user">
            <div className="avatar">
              <img
                src={`data:image/svg+xml;base64,${cuImage}`}
                alt="avatar"
              />
            </div>
            <div className="username">
